...
//    키워드로 이름을 지어줄 수 없다.
//    따라서 50여가지의 키워드를 모두 암기해야한다-> 내일7시 시험 -> 옛날 옛적 이야기...
//    이클립스는 키워드를 자주색으로 표시를 해준다.

// 2. 낙타등 표기법(Camel Back Notation)
//    낙타등 표기법이란, 어떤 이름이 여러개의 단어로 이루어져 있을 경우
//    단어 간의 구분을 쉽게하기 위해서 두번째 단어부터는 매단어의 첫글자를
//    대문자로 적어주는 표기법을 뜻한다.
//    playandplug -> playAndPlug

// 3. 뱀 표기법(Snake Notation)
//    뱀 표기법이란, 모든 철자를 대문자로 적어주는 경우,
//    각 단어의 사이에 _를 넣어서 단어의 구분을 쉽게 할 수 있게하는 표기법이다.

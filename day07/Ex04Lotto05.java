...
public class Ex04Lotto05 {
    public static void main(String[] args) {
        ...
        // 컴퓨터의 숫자를 저장할 int 1차원 배열의 선언과 초기화
        ...
        // computerNumbers와 userNumbers의 각 배열의 같은 숫자를 센다.
        for (int i = 0; i < userNumbers.length; i++) {
        ...
        for (int i = 0; i < userNumbers.length; i++) {
            ...
            for (int j = 0; j < userNumbers[i].length; j++) {
                ...
                if (j != userNumbers[i].length - 1) {
                    ...
                    System.out.println("] - 총 맞은 갯수: " + count[i] + "개");
                }
            }
        }
    }

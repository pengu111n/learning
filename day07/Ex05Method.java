...
public class Ex05Method {
    public static void main(String[] args) {
        // 우리가 각자 이름을 이쁘게 출력하는 코드를 만들고 5번 반복해보자
        printName();
        printName();
        printName();
        printName();
    ...
    // 2개의 int 값에 대한 산술연산자 결과값을 이쁘게 출력하는 printCalcResult() 메서드
    // 이 메서드의 리턴 타입은? void

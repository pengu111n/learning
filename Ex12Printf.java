...
public class Ex12Printf {
    public static void main(String[] args) {
        ...
        // 2-E 실수를 오른쪽 정렬 10자리로 하되 왼쪽 빈공간이 있으면 0으로 채우고
        // 소수점은 3번째 자리까지 출력해라
